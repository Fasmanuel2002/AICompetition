...
class CrossValidator:
    ...
    def _train_epoch(self, model, optimizer, loader):
        ...
        print("===============================================================")
        print(f"For the Training Total loss per epoch: {loss}")
    ...
    def _validate_epoch(self, model, loader):
        ...
        with torch.no_grad():
            for imu, thm, tof, labels in loader:
                ...
                total += labels.size(0)
        print(f"For the Validate Total loss per epoch: {loss}")
        print(f"For the Validate Accuracy per epoch: {(correct / total) * 100}")
        print("=====================================================================")
